...
summary(resul.pois3)
```
    El intervalo de credibilidad al 95% de $\beta_1$ es [-0.02354788, -0.01394777] lo que significa que no incluye el valor 0. Por lo tanto, la relación entre los años y el número de accidentes es estadísticamente significativa. Como $\beta_1 < 0$ esto significa que conforme aumentan los años se espera que el nuemro de accidentes baje.
